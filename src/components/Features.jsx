        ...
        <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
          ...
          <BentoTitl className="bento-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-0">
            <BentoCard 
              ...
              title={<>n<b>e</b>xus</>}
              description="A gamfied social hub, adding a new dimension of play to social interaction for Web3 communities."
            />
          </BentoTitl>
          <BentoTitl className="bento-tilt_1 me-14 md:col-span-1 md:me-0">
            <BentoCard 
              ...
              title={<>az<b>u</ b>l</>}
              description="A cross-productive AI Agent - elevating your gameplay to e more fun and productive."
            />
          </BentoTitl>
